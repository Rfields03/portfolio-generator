...
`;
  ...
  const featuredProjecs = projectHtmlArr.filter(project => {
    if (project.feature) {
      return true;
    } else {
      return false;
  ...
  const nonFeaturedProjects = projectHtmlArr.filter(project => {
    if (!project.feature) {
      return true;
    } else {
      return false;
...
module.exports = templateData => {
  ...
  // destructure page data by section const { projects, about, ...header } = templateData;
